...
* Unlike bitcoind that has the wallet and chain intermingled in the same process
  ...
  [btcwallet](https://github.com/michelvankessel/btcwallet).
...
such as [btcwallet](https://github.com/michelvankessel/btcwallet) for inter-process
...
[rpcclient](https://github.com/michelvankessel/btcd/tree/master/rpcclient) package.
...
[rpcclient](https://github.com/michelvankessel/btcd/tree/master/rpcclient) package to connect with
