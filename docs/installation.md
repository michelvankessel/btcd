...
* Install the MSI available at: [btcd windows installer](https://github.com/michelvankessel/btcd/releases)
...
```bash
git clone https://github.com/michelvankessel/btcd $GOPATH/src/github.com/michelvankessel/btcd
...
* [Using bootstrap.dat](https://github.com/michelvankessel/btcd/blob/master/docs/configuration.md#using-bootstrapdat)
