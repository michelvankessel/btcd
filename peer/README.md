...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/michelvankessel/btcd/peer)
...
```bash
$ go get -u github.com/michelvankessel/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/michelvankessel/btcd/peer#example-package--NewOutboundPeer)  
