...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/michelvankessel/btcd/wire)
=======
...
```bash
$ go get -u github.com/michelvankessel/btcd/wire
```
